...
Operation AI는 서로 다른 AI Agent가 하나의 프로젝트를 수행할 때 업무·권한·맥락·근거·완료 조건을 안전하게 전달하고 충돌을 사람의 결정으로 조정하는 **Agent Handoff & Context Coordination** 프로토타입입니다.

현재 특정 공모전이나 출품을 전제로 하지 않으며, 유사·관련 제품의 존재와 무관하게 독립적인 제품 방향과 실제 구현 범위를 기준으로 설명합니다.
